...
// bootRun --args='--spring.batch.job.name=systemLogJob inputFile=/Users/seokju/study/death-spring-batch/kill-batch-system-boot/src/main/resources/chapter02-files/system-events.log'
@Slf4j
@Configuration
